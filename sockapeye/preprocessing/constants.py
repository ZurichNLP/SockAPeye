...
MOSES_HOME = '/Users/raphael/projects/sockeye-toy-models/tools/moses-scripts' # os.environ.get('MOSES_HOME') if os.environ.get('MOSES_HOME') else ''  # Moses base directory
...
SUBWORD_NMT_HOME = '/Users/raphael/projects/sockeye-toy-models/venvs/sockeye3/lib/python3.6/site-packages/subword_nmt/' # + os.environ.get('SUBWORD_NMT_HOME') if os.environ.get('SUBWORD_NMT_HOME') else ''  # Subword NMT base directory
